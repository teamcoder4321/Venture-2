...
def sendMessage():
    ...
    if a == 1:
        ...
        pywhatkit.sendwhatmsg("+919616566423", message, time_hour=strTime, time_min=update)
        
    elif a == 2:
        speak("Whats the message?")
        message = str(input("enter the message- "))
        pywhatkit.sendwhatmsg("+918115295520", message, time_hour=strTime, time_min=update)